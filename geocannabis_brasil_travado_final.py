...
print("📏 RECALIBRANDO VARIÁVEIS E TRAVANDO MAPA NO BRASIL...")
...
# 2. CONFIGURAÇÃO DO MAPA - TRAVAMENTO DEFINITIVO (CERCAMENTO)
...
# Note que a variável agora se chama layout_html para bater com o comando final.
layout_html = f"""
    <style>
...
mapa.save('GEOCANABIS_BR_FINAL.html')
print("✅ OPERAÇÃO CONCLUÍDA. MAPA GERADO: GEOCANABIS_BR_FINAL.html")