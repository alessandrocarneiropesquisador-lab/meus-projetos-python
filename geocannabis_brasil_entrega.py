...
print("📏 EXECUTANDO AJUSTE FINAL: TÍTULO, ESPAÇAMENTO E TRAVAMENTO GEOGRÁFICO...")
...
# 2. CONFIGURAÇÃO DO MAPA - TRAVAMENTO ABSOLUTO NO BRASIL
# Coordenadas dos limites do Brasil com margem de segurança para evitar cortes
...
# 6. INTERFACE: TÍTULO ATUALIZADO, ESCALA À ESQUERDA, CRÉDITOS À DIREITA
layout_final = f"""
    <style>
        /* ESCALA À ESQUERDA - Trazida para dentro da margem */
    ...
    <div style="position: fixed; bottom: 20px; right: 20px; z-index: 9999; text-align: right;">
        ...
        <div style="font-family: Arial, sans-serif; font-size: 11px; line-height: 1.8; color: black; background: rgba(255,255,255,0.7); padding: 5px; border-radius: 3px;">
            Produzido por: Alessandro Carneiro<br>
            Dados: Prof. Dr. Paulo Fraga
        </div>
    </div>
"""
mapa.get_root().html.add_child(folium.Element(layout_final))

mapa.save('GEOCANABIS_BR_ENTREGA.html')
print("✅ MAPA TRAVADO E ATUALIZADO: GEOCANABIS_BR_ENTREGA.html")